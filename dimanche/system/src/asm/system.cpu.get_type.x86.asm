...
FEATURE_SSSE3 EQU 00000040h + FEATURE_SSE3
FEATURE_FMA_BIT EQU 00000080h
FEATURE_SSE41 EQU 00000100h + FEATURE_SSSE3
...
PROC di_system_cpu_get_type_asm, global
...
_CHECK_SSE_TECHNOLOGIES:
    ...
    ; set SSSE3 bit
    test ecx, CPUID_SSSE3_BIT
    mov feature_list, FEATURE_SSSE3
    jnz _CHECK_ADVANCED_TECHNOLOGIES
